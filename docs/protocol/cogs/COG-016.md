...
Venues SHOULD ship a `hitl` skill ([COG-11](./COG-011)) in the venue skill library so any agent can discover and load the HITL capability. The skill bundles:
...
- [COG-11: Agent Lifecycle](./COG-011) — agents and skills

  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        alt: 'Covia Logo',
        src: 'img/covia.png',
        // Deep-link straight to the docs landing page: '/' has no page of its
        // own — it is a static redirect generated by plugin-client-redirects,
        // and linking to it would fail the broken-links check.
        href: '/docs/overview/'
      },
      items: [
        {
